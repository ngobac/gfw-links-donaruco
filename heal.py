...
import requests
from common import (GEOSTORE_URL, agol_token, canonical, choose_features,
                    fetch_features, get_id, load_links, notify, post_geostore,
                    save_links)
...
def main():
    ...
    for p in data["plots"]:
        ...
        if geoms is None:
            feats, _ = choose_features(fetch_features(agol_token()))
